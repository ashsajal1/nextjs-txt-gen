...
export default function notfound() {
    return (
        <div className='flex flex-col text-violet-600 shadow gap-4 items-center justify-center p-24 h-screen'>
            <h1 className='text-3xl font-extrabold'>Invalid Route</h1>
            <div className='w-[200px]'>
                <Link className='p-2 rounded border bg-violet-600 hover:bg-slate-50 flex items-center justify-center gap-1 text-sm text-slate-50 hover:text-gray-600 transition duration-200' href={'/'}>
